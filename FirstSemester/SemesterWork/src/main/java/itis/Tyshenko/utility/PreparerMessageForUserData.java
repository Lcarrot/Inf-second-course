...
public class PreparerMessageForUserData {

    private final Map<SignUpStatus, String> statusDescription;
    private final List<SignUpStatus> statuses;
    private UserDataCheckerRegistration registration;
    private final UserDTO userDTO;

    public PreparerMessageForUserData(UserDTO userDTO, String password, String confirmed_password) {
    ...
    public static StringBuilder concatAllErrorsSignUpStatus(List<SignUpStatus> statuses, Map<SignUpStatus, String> statusDescription) {
