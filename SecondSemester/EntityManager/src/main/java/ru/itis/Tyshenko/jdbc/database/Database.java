...
import ru.itis.Tyshenko.jdbc.template.RowMapper;
...
public abstract class Database {
    ...
    public Database(DataSource dataSource, ru.itis.Tyshenko.converter.Database database) {
    ...
    public abstract static class AbstractDatabase implements ru.itis.Tyshenko.converter.Database {

        @Override
        public abstract String addFieldType(Field field) throws UnknownFieldTypeException;

        @Override
        public abstract String getSeparatorBetweenValueAndType();
